...
detects= singlematrix[-200:-1, int(0.8*199)]/np.sum(singlematrix[-1, :])
detectd= doublematrix[-200:-1, int(0.8*199)]/np.sum(doublematrix[-1, :])
detectt= triplematrix[-200:-1, int(0.8*199)]/np.sum(triplematrix[-1, :])
